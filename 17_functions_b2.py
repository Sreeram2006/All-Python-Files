...
int, str,dic,list, tuple,set , loops, if else
...
def sum(a,b):  # here we call a, b as parameters
  return a+b

x= 8
y = 9
sum(6,7)  # we will call the parameters as arguments when calling a function

def sum(a,*b):  # here we call a, b as parameters
  print(b)
  for i in b:  # i in (2,3,4,5,6)
    sum = a + i
    print(sum)
  #return a+b[2]
...
def text_squarepattern(n):
  for row in range(n):
    for col in range(n):
      print("😊", end = " ")
    print("")

text_squarepattern(6)

def text_halfpyramidpattern(n):
  for row in range(n): #(0,1,2,3,4,5)
    for col in range(row+1):
      print("😊", end = " ")
    print("")

text_halfpyramidpattern(6)
...
def print_1():
  ...
  print(f"Hii {x}, How are you") # 3 "hi", x, "how are u"
  print("Hii {}, How are you {}".format(x,x+"Durga"))


print_1()   # calling the function
...
def greet():
  ...
  print(f"Hii {ask} , Have a nycc day!!")

greet()   # we should call th function after defining the function
...
ask = input("enter a operation you want to perform: ")
def cal(a,b) :
  if ask == "sum" :
    sum(a,b)
